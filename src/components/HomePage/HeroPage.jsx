        ...
        <div className="hero-content w-full justify-start text-neutral-content text-center lg:text-left">
          <div className="max-w-md text-left">
            ...
            <div className="flex gap-5 flex-col lg:flex-row">
              <button className="btn btn-xl text-white bg-orange-400 rounded-lg flex items-center">
                Shop Now <BiRightArrowAlt />
              </button>
              <button className="btn btn-xl bg-slate-200 rounded-lg flex items-center">
                View LookBook
              </button>
            </div>
          </div>
