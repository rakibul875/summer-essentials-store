      ...
      <div className="lg:mx-10">
        <div className="flex gap-5 mt-5 flex-col lg:flex-row">
          <div className="card bg-base-100 card-xl shadow-sm">
            <div className="card-body">
              <h1 className="bg-blue-100 w-10 flex justify-center text-blue-400 rounded-full px-1 py-2"><MdOpacity size={'1rem'}/></h1>
          ...
          <div className="">
            <div className="card flex-col-reverse lg:flex-row card-side bg-base-100 shadow-sm h-full">
              <div className="card-body">
                 <h1 className="bg-orange-200 text-orange-500 rounded-full flex justify-center w-10 px-1 py-2"><MdOutlineWbSunny size={'1rem'}/></h1>
        ...
        <div className="flex flex-col lg:flex-row gap-5 mt-10">
          <div className="">
            <div className="card flex-col-reverse lg:flex-row card-side bg-base-100 shadow-sm h-full">
              <div className="card-body">
               <h1 className="bg-blue-100 w-10 flex justify-center text-blue-400 rounded-full px-1 py-2"><TbTemperatureSun size={'1rem'} /></h1>
          ...
          <div className="">
            <div className="card bg-base-100 card-xl shadow-sm">
              <div className="card-body">
                ...
                <p>
                  Protect your vision from intense UV rays with polarized lenses
                  and UV-coated optics.
                </p>
                <div className="justify-start card-actions">
                  <button className="btn hover:bg-orange-500 hover:text-white btn-outline rounded-xl border-orange-500 text-orange-500">
                    Shop Eyewear
